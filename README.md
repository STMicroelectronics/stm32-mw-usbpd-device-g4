# STM32G4 Device-Specfic USB Power Delivery Middleware Library MCU Software Component
...
This repository provides the STM32Cube **device-specific** Middleware Library of the **STM32CubeG4** MCU firmware for managing the **USB Type-C** physical layer.
